...
R_API int r_meta_list_json(RAnal *m, int type, int rad);
R_API int r_meta_list_at_json(RAnal *m, int type, int rad, ut64 addr);
R_API int r_meta_list_cb_json(RAnal *m, int type, int rad, SdbForeachCallback cb, void *user, ut64 addr);
